  ...
  return {
    ...
    execute: function () {
      ...
      _export("PluginNode", PluginNode = (_dec = ccclass('PluginNode'), _dec2 = (_crd && cbBase === void 0 ? (_reportPossibleCrUseOfcbBase({
        ...
        error: Error()
      }), testPlugin) : testPlugin).cbList), _dec(_class = (_class2 = (_temp = /*#__PURE__*/function (_Component) {
        _inheritsLoose(PluginNode, _Component);
        ...
        function PluginNode() {
          ...
          _defineProperty(_assertThisInitialized(_this), "fw", null);

          _defineProperty(_assertThisInitialized(_this), "cbList", []);

          return _this;
        }

        var _proto = PluginNode.prototype;
        ...
        _proto.test1 = function test1() {} // update (deltaTime: number) {
        //     // [4]
        // }
        ;

        return PluginNode;
      }(Component), _temp), (_applyDecoratedDescriptor(_class2.prototype, "test1", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "test1"), _class2.prototype)), _class2)) || _class));
      /**
